 ...
 */
Entity::Entity(std::string s, sf::Vector2f position, sf::Vector2f size, sf::Color color){
    ...
    mObject.setTextureRect(sf::IntRect(0, 0, size.x, size.y));
    ...
    //set position at the middle of the Entity
