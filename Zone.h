...
private:
    ...
    char maze1[][10] =            {{'X', 'G', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 1
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 2
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 3
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 4
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 5
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 6
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 7
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 8
                                   {'X', '-', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 9
                                   {'X', 'G', 'X', 'X', 'X', 'X', 'X', 'X', 'X', 'X'},      //line 10
